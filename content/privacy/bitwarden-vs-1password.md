...
> ⚠️ 定價更新：[Bitwarden](https://bitwarden.com/) Premium 於 2026 年從 $9.99 漲至 $19.80/年；[1Password](https://1password.com/) 亦於 2026 年 3 月調漲，本文定價已更新。
...
| 無限密碼（免費版）| 是 | — |
| 跨裝置同步（免費版）| 是 | — |
| 第三方安全稽核 | 每年執行，[SOC 2](https://en.wikipedia.org/wiki/System_and_Organization_Controls) Type 2 通過 | 24 次完整稽核，ISO 27001 等多項認證 |
...
免費版包含：無限密碼儲存、無限裝置同步、基本[兩步驟驗證](https://zh.wikipedia.org/wiki/%E5%A4%9A%E9%87%8D%E8%AA%8D%E8%AD%89)（TOTP app 或 email）、資料外洩基本檢查、文字型的安全傳輸功能（Send）。這些對個人日常使用幾乎已經覆蓋完整。
