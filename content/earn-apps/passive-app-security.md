...
**Honeygain** 由立陶宛公司 Tengai 營運，2019 年成立，有明確的公司實體和公開的投資背景，條款符合 [GDPR](https://en.wikipedia.org/wiki/General_Data_Protection_Regulation) 規範。
...
對 IP 聲譽有要求的工作：如果你的工作涉及 SEO、廣告投放、或其他需要乾淨 IP 的業務，讓這些平台使用你的 IP 可能造成你自己的 IP 被目標平台列為代理 IP 而封鎖。順帶一提，這類「分享 IP」的方向，和[上班族到底需不需要 VPN](/privacy/do-you-need-vpn/)所談的「隱藏 IP」剛好相反——一個把你的住宅 IP 借出去，一個把你的出口 IP 藏起來，搞清楚你要的是哪一種。
